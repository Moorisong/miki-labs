...
export const metadata: Metadata = {
    title: 'HowTheySeeMe | 친구들이 보는 나를 발견하세요',
    description:
        'HowTheySeeMe(HTSM)는 친구들의 익명 평가를 통해 "내가 보는 나"와 "남이 보는 나"를 비교하는 Johari Window 기반 심리 분석 서비스입니다. 10초만에 테스트를 만들어보세요.',
    keywords: [
        'HowTheySeeMe', 'HTSM', 'Johari Window', '조하리 창',
